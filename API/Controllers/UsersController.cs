...
namespace API.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        {
            return await _uow.UserRepository.GetMemberAsync(userName); //get entity from memmory from this request
        ...
        public async Task<ActionResult> DeletePhoto(int photoId)
        {
            ...
            if(photo.IsMain == true) return BadRequest("You cannot delete main photo");
